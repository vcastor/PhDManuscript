...
\vspace{5em}%
\hspace*{1em}This chapter in contrast to the previous one has no physical chemistry\\ [-0.5em]
\makebox[\linewidth][r]{or mathematical content,}\\ [-0.5em]
\hspace*{2em}but provides additional information about the workflow of the thesis,\\ [-0.5em]
\makebox[\linewidth][r]{that in fact,\hspace{1.5em}}\\ [-0.5em] 
\hspace*{1em}was also a part of the main project of the PhD.%
