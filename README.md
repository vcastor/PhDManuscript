...
1. **Prerequisites** 🏗️
    ...
    - Optional but useful: **Editor Config**, **Python**, **GNUPlot**, **Graphviz**, **GIMP**, **Inkscape**, **Blender**, etc.
...
> ⚠️  **Note**: The use of git on Overleaf is only for premium users. The
project is big so you probably also need compilation time over than the free
time on Overleaf.
